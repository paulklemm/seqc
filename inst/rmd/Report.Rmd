...
params <- list()
params$cuffdiff_path <- '/beegfs/scratch/bruening_scratch/pklemm/htseq-tools-test/cuffdiff_output/TuUp'
params$output_path <- '/beegfs/scratch/bruening_scratch/pklemm/seqcOutput'
