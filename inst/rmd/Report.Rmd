...
Since the heat maps produced by cummeRbund usually look very busy we did a custom implementation of it

```{r custom_heatmap, layout="l-page"}
q_value_cutoff <- 0.05

# Get FPKM per Replicate
cummeRbund::repFpkm(cummeRbund::genes(cuff)) %>%
  tibble::as_tibble() %>%
